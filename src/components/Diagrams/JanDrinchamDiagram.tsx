...
// Jacques, Loys, Francq) → Gen 4 Jan III's children (Philippe, Jan-the-
// legitimated, three daughters). Jacques de Drincham carries the research-
// focus star badge because his Veurne epitaph is the best-documented artifact
// of the entire Drincham line.
//
...
// Gen 4 column centres (four sons)
const G4_C1 = 170;  // Jan III — heir
const G4_C2 = 430;  // Jacques — focus
const G4_C3 = 680;  // Loys
const G4_C4 = 940;  // Francq

// Gen 5 column centres (three children of Jan III + three unnamed daughters)
const G5_C1 = 80;   // Philippe — †
const G5_C2 = 218;  // Jan legitimated — ?
const G5_C3 = 380;  // 3 daughters — ?
