      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ fontSize: '0.9rem', lineHeight: '1.7', color: 'var(--text-muted)' }}>
              (a) <strong>Lodewijk II</strong> &mdash; the heir; Aalter tomb attested;<Cite n={1} text={CITES[1]} loc="Pars secunda, pp. 277–278" repeat /> (b) <strong>Ioanna (Jeanne) de Flandre</strong> &mdash; m. Jean, Lord of Pouques; 1446 partition record<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 278" repeat /> (a further marriage-contract document of 24 Jan 1441 is known to the project only through Buylaert,<Cite n={6} text={CITES[6]} loc="p. 567" /> as cited in C. Cawley, 'Medieval Lands', FMG<Cite n={2} text={CITES[2]} />); (c) <strong>Margareta (Marguerite) de Flandre</strong> &mdash; m. Louis de Bailleul; Grimarez and Van Hecke extracts<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 278 (Grimarez & Van Hecke extracts)" repeat /> (attribution structurally inferential, see note below); (d) <strong>Lisbette (Isabelle) de Flandre</strong> &mdash; m. Waleran, Lord of Landas and Warlain;<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 279" repeat /> (e) <strong>Landrada de Flandre</strong> &mdash; Canoness at St. Waudru, Mons; never married.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 279" repeat /> A March 1442 Ghent partition records the three minor children (Lodewijk II, Lisbette, and Landrada) under guardianship after Johan I&rsquo;s death; Ioanna and Margareta were by then already married.
            </p>
            <p style={{ fontSize: '0.85rem', lineHeight: '1.7', color: 'var(--text-muted)', marginTop: '0.75rem', fontStyle: 'italic' }}>
              <strong>Correction noted.</strong> An earlier version of this dossier attributed seven children to Johan I, including Jean de Flandre (d. 1523, Heer van Onlede en Beveren, Grand Bailiff of Bruges) and Josse de Flandre (d. after 1526). Direct reading of Vredius in April 2026 resolves these two figures as sons of Lodewijk II, not of Johan I: the Beveren tomb inscription explicitly identifies Jean&rsquo;s father as &lsquo;Messire <strong>Loys</strong> de Flandres, Chevalier, Saigneur de Praet&rsquo; (i.e., Lodewijk II, d. 1488).<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 280 (Beveren tomb inscription)" repeat /> Damhouder&rsquo;s list of Lodewijk II&rsquo;s six children by Louise de Bruges confirms both Jean and Josse as Lodewijk II&rsquo;s sons.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 278 (Damhouder list)" repeat /> Margareta de Flandre&rsquo;s attribution to Johan I is structurally inferential (from the &lsquo;sorores Ludovici Patris&rsquo; heading) rather than directly textual, and is treated here as probable.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 278 (‘sorores Ludovici Patris’ heading)" repeat /> Buylaert 2011 (not yet consulted directly) is the definitive arbiter on these attributions.<Cite n={6} text={CITES[6]} repeat />
            </p>
          </div>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              Two primary sources agree on the year (1488) but disagree on the day. The Aalter tomb inscription reads: &lsquo;Voor den hooghen autaer light M&rsquo;her LODEWYC van Vlaenderen/ Heere van Praet/ ende vanden lande van Woestine/ Bevere/ ende Ornlede/ fs. M&rsquo;her Jans/ Rudder/ Heere van Praet&hellip; die starf 1488. op S. Baefs dach&rsquo; &mdash; St. Bavo&rsquo;s day, 1 October 1488.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 277 (Aalter tomb inscription)" repeat /> De l&rsquo;Espinoy, quoted by Vredius, reads: &lsquo;lequel Messire Loys de Flandre, mourut en l&rsquo;an 1488, le jour de S. Berthelemy&rsquo; &mdash; St. Bartholomew&rsquo;s day, 24 August 1488.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 278 (de l’Espinoy, quoted by Vredius)" repeat /> Both sources agree he married &lsquo;vrau Loije van Brugghe fs mijns heeren Jans heere van Gruuthuuse&rsquo; &mdash; Louise de Bruges, daughter of Jan van de Aa dit de Bruges, Heer van Gruuthuse en Grimbergen.
            </p>
            ...
            <p style={{ fontSize: '0.9rem', lineHeight: '1.7', color: 'var(--text-muted)' }}>
              Damhouder&rsquo;s extract names six children by Louise de Bruges: &lsquo;Loys, Iean, Iaques, Ioffe, Loyfe, &amp; Iehenne de Flandre.&rsquo;<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 278 (Damhouder extract)" repeat /> (a) <strong>Lodewijk III (Loys)</strong> &mdash; the heir, see below; (b) <strong>Jean de Flandre</strong> (d. 6 September 1523), Heer van Onlede en Beveren bij Roeselare, Grand Bailiff of Bruges and the Brugse Vrije; Beveren tomb inscription;<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 280 (Beveren tomb inscription)" repeat /> (c) <strong>Jaques (Jacques) de Flandre</strong> &mdash; named only in Damhouder&rsquo;s list; no further biographical detail in Vredius, and his identification is not established. He did not inherit Praet (it passed to his brother Lodewijk III), and he must not be confused with <strong>Jacob van Vlaanderen</strong> (d. 1566), Joos&rsquo;s son one generation later, who <em>did</em> inherit &mdash; receiving Praet and Woestijne in 1550 (see the collateral continuation below); (d) <strong>Josse (Ioffe) de Flandre</strong> &mdash; Joos van Vlaenderen (d. before 30 Nov 1545), inherited Onlede, Beveren, and Wijchuize after his brother Jean; married Martina van Moerkerke; the cadet branch through which the line continued after 1545;<Cite n={6} text={CITES[6]} loc="p. 747" repeat /><Cite n={7} text={CITES[7]} repeat /> (e) <strong>Louise (Loyfe) de Flandre</strong>; (f) <strong>Iehenne (Jeanne) de Flandre</strong>. Note on possible name confusion: this Iehenne (daughter of Lodewijk II) is a different person from Johan I&rsquo;s daughter Ioanna-m-Pouckes (see above); the two Jeannes are in adjacent generations and must not be conflated.
            </p>
          </div>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              The Aalter tomb inscription reads: &lsquo;Op den Maendagh 1490 starf M&rsquo;her LOYS van Vlaendren/ heere van Praet/ die ghetrauwt hadde Vrauwe ISABELLE van Bourgongnen; hy light alhier by zijnen Vader&rsquo; &mdash; a Monday in 1490, buried beside his father.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 279 (Aalter tomb inscription)" repeat /> His death is dated to New Year&rsquo;s 1490. Grimarez&rsquo;s reading &lsquo;1488. 1. Ianvier&rsquo; is a conflation with his father Lodewijk II&rsquo;s death year (1488) &mdash; a logged known error, not a competing date.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 279 (Grimarez reading)" repeat /> His marriage to Isabelle de Bourgogne, daughter of Jean b&acirc;tard de Bourgogne Heer van Elverdinghe en Vlamertinghe and Marie d&rsquo;Halluin, is confirmed by the same tomb.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 279 (Aalter tomb inscription)" repeat /> Isabelle died &lsquo;12 Nov 1504&rsquo; and was buried &lsquo;te Gent, te Galilee.&rsquo;
            </p>
          </div>

          <div style={{ marginBottom: '2.5rem' }}>
            <h3 style={{ color: 'var(--gold)', fontSize: '1.1rem', marginBottom: '0.5rem' }}>Lodewijk IV van Vlaenderen / Louis of Praet (d. 1556, working date) <span className={`${researchStyles.evidenceLevel} ${researchStyles.levelAttested}`}>Directly Attested</span></h3>
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              The Aalter tomb inscription records his full titulature: &lsquo;M&rsquo;her LODEWYC van Vlaendren/ Rudder vander Ordre vanden Gulden Vliese/ Heere van Praet/ vanden lande vander Woestyne/ Elverdijnghe/ Vlamertijnghe/ Spiete/ ende vander Mersch/ Raed/ Upper-camerlinck/ Chief vande Financien van de K.M. Carolus den V. ende sijnen Hoogh-Bailliu van Brugghe/ ende van &rsquo;t Brughsche Vrije/ te sijnen overlijden Gouverneur ende Capitain van Vlaendren/ die starf 1555.&rsquo;<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 387 (Aalter tomb inscription)" repeat /> Knight of the Golden Fleece (1531); Grand Bailiff of Ghent and Bruges; Stadtholder of Holland, Zeeland and Utrecht (1544&ndash;1546); Advisor to Emperor Charles V.
            </p>
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              Married Jossine van Praet, daughter of Charles van Praet Heer van Moerkercke, heiress of the original Praet baronial family. The same Aalter tomb inscription records her death: &lsquo;Ende Me-vrauwe IOSYNE van Praet/ Vrauwe van Moerkercke/ M&rsquo;her Charles van Praet/ Heere van Moerkercke dochter was/ M&rsquo;her LODEWYCX ghesselnede/ die starf 1546. den 10. December&rsquo; &mdash; died 10 December 1546, buried beside her husband at Aalter.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 387 (Aalter tomb inscription)" repeat />
            </p>
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              <strong>Death-year cross-flag</strong> <span className={`${researchStyles.evidenceLevel} ${researchStyles.levelProbable}`}>Probable</span> &mdash; Lodewijk IV&rsquo;s death year is attested three ways. Vredius&rsquo;s print of the Aalter inscription reads &lsquo;die starf 1555,&rsquo;<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 387 (Aalter tomb inscription)" repeat /> and Verhoustraete likewise carries 1555.<Cite n={7} text={CITES[7]} repeat /> Gailliard reports the tombstone itself as <em>&lsquo;obiit MDLVIII&rsquo;</em> &mdash; 1558 &mdash; yet his own prose on the same page states <em>&lsquo;Il d&eacute;c&eacute;da en 1556,&rsquo;</em><Cite n={11} text={CITES[11]} loc="Tome I, p. 261" /> and the monument itself was lost when the Aalter church was destroyed c. 1590, so the 1558 reading survives only as Gailliard&rsquo;s transcription of a defective exemplar (the day left blank). Modern scholarship also carries 1556 (Buylaert &amp; Adriaens, <em>Lordship, Capitalism, and the State in Flanders</em>, 2025, p. 179). The project&rsquo;s working date is <strong>1556</strong> (adjudicated 2026-07-16), held at Probable pending documentary resolution &mdash; tracing Gailliard&rsquo;s source for the inscription and a primary death or succession act.
            </p>
          </div>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              The Aalter tomb inscription reads: &lsquo;Inde selve tombe light Jo. IAN van Vlaendren/ Heere van Woestine/ Elverdinghe/ ende Vlamertinghe/ fil. mijns Heeren Lodewijc/ Heere van Praet/ ende van Vrauw&rsquo; Josijne voorseyt/ die starf 1545. den 10. December; hy hadde ghetrauwt Vrauw&rsquo; IAQVELINE van Bourgongnen/ fil. M&rsquo;her Adolf/ Heere van Bevere/ starf sonder generatie.&rsquo;<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 388 (Aalter tomb inscription)" repeat /> Grimarez adds that he &lsquo;mourut, sans generation, avant son pere, en l&rsquo;an 1545&rsquo; &mdash; he predeceased his father Lodewijk IV, dying without issue.<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 388 (Grimarez)" repeat /> His death ends the <strong>senior direct male line only</strong>: the lordship and the surname passed to the collateral branch of Joos van Vlaenderen, whose son Jacob received Praet and Woestijne at Aalter in 1550 (see below). A separate epitaph at Veere &mdash; B&eacute;thune, <em>Epitaphes</em> (third part, 1900), p. 392,<Cite n={3} text={CITES[3]} loc="third part, 1900, p. 392 (Veere epitaph)" /> as cited in C. Cawley, 'Medieval Lands' (FMG);<Cite n={2} text={CITES[2]} repeat /> not yet read directly &mdash; records that his widow Jacqueline de Bourgogne remarried Jan Heer van Cruijningen and died &lsquo;van haer laetste kint&rsquo; at Beveren in 1556 &mdash; in childbirth with her last child by her second husband &mdash; and that she was childless by Jan van Vlaenderen.
            </p>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              Named as Lodewijk II&rsquo;s son &lsquo;Ioffe de Flandre&rsquo; in Damhouder&rsquo;s list of the six children;<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 278 (Damhouder list)" repeat /> documented by Buylaert<Cite n={6} text={CITES[6]} loc="p. 747" repeat /> and Verhoustraete.<Cite n={7} text={CITES[7]} repeat /> After the death in 1523 of his brother Jean de Flandre Heer van Onlede, Joos inherited &lsquo;de heerlijkheden Onlede, Beveren en Wijchuize.&rsquo; He married Martina van Moerkerke and had &lsquo;verschillende kinderen&rsquo;; Serrure 1863 names his children Jacob, Philips, and Philippote,<Cite n={8} text={CITES[8]} repeat /> and his sons Jacob and Philips appear as minor wards in the Honnelede wardship file.<Cite n={10} text={CITES[10]} loc="nrs. 21300–21302 (1545–49)" repeat /> He died <strong>before 30 November 1545</strong> <span className={`${researchStyles.evidenceLevel} ${researchStyles.levelAttested}`}>Directly Attested</span>: the wardship file names him posthumously (<em>&lsquo;Joncher Joost van Vlaendren, in syn leven heere van Honnelede&rsquo;</em>), with its earliest account year beginning on St. Andrew&rsquo;s Day, 30 November 1545.<Cite n={10} text={CITES[10]} loc="Staten van Goed, nrs. 21300–21302 (1545–49)" repeat /> The older printed death-year 1553 (Verhoustraete) rests on the same bundle and is corrected against the original.<Cite n={7} text={CITES[7]} repeat /> This is the cadet branch through which the Praet line continued after the 1545 senior failure.
            </p>
          </div>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              Jacob&rsquo;s son and the last male of the line. A Calvinist, he married Maria van Marnix, who died childless in 1580; he sold the encumbered Praet/Aalter estate before his death and died sonless on All Saints&rsquo; Eve, 31 October 1591, in exile.<Cite n={7} text={CITES[7]} loc="pp. 101–113" repeat /><Cite n={9} text={CITES[9]} repeat /> With his death the surname &lsquo;van Vlaenderen&rsquo; in this branch ends &mdash; see the terminus section below.
            </p>
          </div>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              Charters dated 1478 and 1486 record that 'Marguerite de Flandres' (daughter of Lodewyc van Vlaenderen, Victor's son) married firstly Lodewijk van Baenst Heer van Santvelde and secondly Adriaan van Schouteten Heer van Erpe.<Cite n={1} text={CITES[1]} loc="p. 287 (Grimarez, Ghent partition registers)" repeat /> This is from Victor's line, not the Praet line &mdash; noted here to distinguish the two Margaretha van Vlaenderens documented in the 15th century.
            </p>
          </div>
        </section>
