      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ fontSize: '0.95rem', lineHeight: '1.7' }}>
              <strong>Death-year cross-flag</strong> <span className={`${researchStyles.evidenceLevel} ${researchStyles.levelProbable}`}>Probable</span> &mdash; Lodewijk IV&rsquo;s death year is attested two ways. Vredius&rsquo;s print of the Aalter inscription reads &lsquo;die starf 1555,&rsquo;<Cite n={1} text={CITES[1]} loc="Pars secunda, p. 387 (Aalter tomb inscription)" repeat /> and Verhoustraete likewise carries 1555.<Cite n={7} text={CITES[7]} repeat /> Gailliard, however, reports the tombstone itself as <em>&lsquo;obiit MDLVIII&rsquo;</em> &mdash; 1558.<Cite n={11} text={CITES[11]} loc="Tome I, p. 261" /> The project&rsquo;s working preference is 1558, weighting the epigraphic transcription over the secondary print tradition, held at Probable pending a re-examination of the Aalter monument.
            </p>
          </div>
