...
export default function DnaPage() {
  return (
    <div className={styles.page}>
      ...
      {/* ── Content with DNA helix background ────────────────────── */}
      <div className={dnaStyles.contentWrap}>
        {/* Helix sits behind everything in this section */}
        <div className={dnaStyles.helixBg} aria-hidden="true">
          <DNAHelix opacity={0.50} speed={0.18} />
        </div>
