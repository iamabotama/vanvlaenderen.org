...
export type ResearchSubpage = 'main' | 'victor' | 'louis-friese' | 'robrecht' | 'victor-dossier' | 'praet-dossier' | 'praet-lineage-dossier' | 'methodology' | 'bibliography' | 'gap-dossier' | 'nieus-seals' | 'drincham-dossier';
