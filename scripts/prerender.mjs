...
function writeSitemap(PAGE_META) {
  ...
  const routeMeta = {
    ...
    '/research/robrecht':              { priority: '0.9', changefreq: 'weekly'  },
    '/research/loys-le-hase':          { priority: '0.9', changefreq: 'weekly'  },
    '/research/jan-sans-terre':        { priority: '0.9', changefreq: 'weekly'  },
    '/research/despars-compendium':    { priority: '0.7', changefreq: 'monthly' },
    ...
    '/name/bearers':                   { priority: '0.8', changefreq: 'monthly' },
